...
<head>
    ...
    <link rel="stylesheet" href="assets/css/fincaElSalvador.css">
...
<body>
    <section>
        <h3 class="elSalvadorH3">FINCAS DE HONDURAS</h3>
            <div class="firstContainer">
                <div class="firstContainerSubCont1">
                    <img src="assets/img/FincaElSalvador.png" alt="">
                </div>
                <div class="firstContainerSubCont2">
                    <div class="subContImg">
                        <img src="assets/img/Token1ElSalvador.png" alt="">
                        <img src="assets/img/Token2ElSalvador.png" alt="">
                    </div>
                    <div class="subContText">
                        ...
                        <button>
                            <a href="compraHonduras.php">BUY IT</a>
                        </button>
                    </div>
                </div>
            </div>
